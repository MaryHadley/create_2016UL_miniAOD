...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Y1S3S11_Z_4Mu_HO_SPS_HLT.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Y1S3S11_Z_4Mu_HO_SPS_AOD.root'),
