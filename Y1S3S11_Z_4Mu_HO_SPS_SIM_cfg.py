...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(598)
)

# Input source
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Y1S3S11_Z_4Mu_HO_SPS_1st_LHE.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--python_filename nevts:598'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Y1S3S11_Z_4Mu_HO_SPS_SIM.root'),
